...
"""Ahora,para ver los datos de cada tabla, llame la funcion que corresponde a la tabla, 
el nombre de la funcion corresponde al nombre de la tabla"""         
diagnosis()
