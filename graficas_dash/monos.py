...
dfCases1 = pd.DataFrame(query1, columns=["departamento", "numero_casos", "anio"])
...
figLineCases = px.line(dfCases1.head(20), x = "anio", y = "numero_casos", color = "departamento", title = 'NÚMERO DE INFECCIÓN POR DEPARTAMENTO-LINEAS')


#Casos por estrato
dfCases2 = pd.DataFrame(query2, columns = ["estrato", "numero_casos"])
figBarCasesClass = px.bar(dfCases2.head(20), x = "estrato", y = "numero_casos", title = 'NÚMERO DE INFECCIÓN POR ESTRATO-BARRAS')
